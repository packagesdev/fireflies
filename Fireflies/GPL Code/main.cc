...
"  0: normal                                         p=30\n"
"  1: stop (bait stays still for a brief period)     p=10\n"
"  2: circle (bait loops in a circle briefly)        p=10\n"
"  3: rainbow (color cycle speeds up)                p=10\n"
"  4: glow (tails glow as their width increases)     p=15\n"
"  5: hyperspeed (swarm speeds up)                   p=10\n"
"Major modes and their default probabilities:\n"
"  0: all swarms pick a random per-swarm mode        p=5\n"
"  1: kill some flies                                p=10\n"
"  2: make some new flies                            p=10\n"
"  3: wind speed picks up                            p=20\n"
"  4: matrix-style pause and rotate of the scene     p=20\n"
"  5: split a random swarm into two swarms           p=10\n"
"  6: merge two random swarms into one               p=10\n"
